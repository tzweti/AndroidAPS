...
public class GraphPlugin implements PluginBase {
    ...
    public String getName() {
        return MainApp.sResources.getString(R.string.graph);
    }

    @Override
    public String getNameShort() {
        String name = MainApp.sResources.getString(R.string.graph_shortname);
